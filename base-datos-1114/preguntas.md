...
R/ Json se utiliza para mostrar y utilizar la base de datos de forma rapida y sencilla mientras que SQlite se usa para guardar y consutar a la base de datos 